...
| WithSSMClient    | N/A                 | `WithSSMClient(client)` — use the given SSM client instead of one built from AWS config (e.g. a mock for testing, or your own preconfigured client); ignores WithSSM's region/profile |
